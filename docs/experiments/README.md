...
|---|---|---|---|---|---|---|
| EXP-20260830-data-source-feasibility | Point-in-time market and weather data feasibility | `IN_PROGRESS` | 2026-08-30 | — | Phase 5: fixed settlement audit passed; third-city observation/revision evidence next | [PLAN.md](EXP-20260830-data-source-feasibility/PLAN.md) |
