...
|---|---|---|---|---|---|---|
| EXP-20260830-data-source-feasibility | Point-in-time market and weather data feasibility | `READY` | 2026-08-30 | — | Pre-registered; execution not started | [PLAN.md](EXP-20260830-data-source-feasibility/PLAN.md) |
