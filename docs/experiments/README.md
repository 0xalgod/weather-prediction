...
| EXP-20260904-chicago-walkforward-calibration-v2 | Post-hoc corrective expanding-window calibration | `IN_PROGRESS` | 2026-09-04 | — | 112 eligible; 60 train / 52 OOS locked before scoring | [PLAN.md](EXP-20260904-chicago-walkforward-calibration-v2/PLAN.md) |
