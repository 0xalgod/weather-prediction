...
|---|---|---|---|---|---|---|
| EXP-20260830-data-source-feasibility | Point-in-time market and weather data feasibility | `IN_PROGRESS` | 2026-08-30 | — | Phase 3 remediated 15m regression + 1h soak passed; replacement 24h next | [PLAN.md](EXP-20260830-data-source-feasibility/PLAN.md) |
