...
| EXP-20260907-multicity-gefs-calibration-v1 | Development-only global GEFS bias/spread calibration | `FAILED` | 2026-09-07 | 2026-09-07 | Calibrated blend worsened validation log loss 27.7%; GEFS branch dropped | [report](EXP-20260907-multicity-gefs-calibration-v1.md) |
